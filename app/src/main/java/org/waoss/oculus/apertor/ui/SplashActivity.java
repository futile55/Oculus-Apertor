...
public class SplashActivity extends AppIntro {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        addSlide(SplashFragment.newInstance(R.layout.app_intro1));
        addSlide(SplashFragment.newInstance(R.layout.app_intro2));
        addSlide(SplashFragment.newInstance(R.layout.app_intro3));
